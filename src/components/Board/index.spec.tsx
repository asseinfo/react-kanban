...
describe('<Board />', () => {
  ...
  describe('when the board is controlled', () => {
    ...
    describe('about the card moving', () => {
      ...
      describe('when the component receives "onCardDragEnd" callback', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2345) FIXME: Argument of type '{ onCardDragEnd: any; }' is not ... Remove this comment to see the full error message
          mount({ onCardDragEnd })
        })
    ...
    describe('about the column moving', () => {
      ...
      describe('when the component receives "onColumnDragEnd" callback', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2345) FIXME: Argument of type '{ onColumnDragEnd: any; }' is no... Remove this comment to see the full error message
    ...
    describe("about the board's custom card", () => {
      // @ts-expect-error TS(7034) FIXME: Variable 'renderCard' implicitly has type 'any' in... Remove this comment to see the full error message
      let renderCard
      const board = {
        columns: [
          {
      ...
      describe('when it receives a "renderCard" prop', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2322) FIXME: Type '{ columns: { id: number; title: string; card... Remove this comment to see the full error message
    ...
    describe("about the column's header", () => {
      // @ts-expect-error TS(7034) FIXME: Variable 'renderColumnHeader' implicitly has type ... Remove this comment to see the full error message
      ...
      describe('when the component receives a "renderColumnHeader" prop', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2322) FIXME: Type '{ columns: { id: number; title: string; wip:... Remove this comment to see the full error message
      ...
      describe('about the default column adder', () => {
        ...
        describe('when the component does not receive "allowAddColumn" prop', () => {
          ...
          beforeEach(() => {
            ...
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ allowAddColumn: boolean; onNew... Remove this comment to see the full error message
        ...
        describe('when the component does not receive "onNewColumnConfirm" prop', () => {
          // @ts-expect-error TS(2304) FIXME: Cannot find name 'beforeEach'.
          beforeEach(() => {
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ allowAddColumn: boolean; }' is... Remove this comment to see the full error message
        ...
        describe('when it receives the "allowAddColumn" and "onNewColumnConfirm" prop', () => {
          // @ts-expect-error TS(7034) FIXME: Variable 'onNewColumnConfirm' implicitly has type ... Remove this comment to see the full error message
          let onNewColumnConfirm
        ...
        describe('when the component receives a custom column adder', () => {
          ...
          describe('when the component does not receive "allowAddColumn" prop', () => {
            ...
            beforeEach(() => {
              ...
              // @ts-expect-error TS(2345) FIXME: Argument of type '{ renderColumnAdder: any; }' is ... Remove this comment to see the full error message
          ...
          describe('when the component receives the "allowAddColumn" prop', () => {
            ...
            beforeEach(() => {
              ...
              // @ts-expect-error TS(2345) FIXME: Argument of type '{ children: { columns: { id: num... Remove this comment to see the full error message
    ...
    describe('about the column removing', () => {
      ...
      describe('when the component receives a custom header column template', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2304) FIXME: Cannot find name 'jest'.
          onColumnRemove = jest.fn()
          // @ts-expect-error TS(2345) FIXME: Argument of type '{ renderColumnHeader: any; onCol... Remove this comment to see the full error message
    ...
    describe('about the column renaming', () => {
      ...
      describe('when the component use the default header template', () => {
        ...
        describe('when the component receives the "allowRenameColumn" prop', () => {
          ...
          beforeEach(() => {
            ...
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ allowRenameColumn: boolean; on... Remove this comment to see the full error message
        ...
        describe('when the component does not receive the "allowRenameColumn" prop', () => {
          ...
          beforeEach(() => {
            // @ts-expect-error TS(2304) FIXME: Cannot find name 'jest'.
            onColumnRename = jest.fn()
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ onColumnRename: any; }' is not... Remove this comment to see the full error message
      ...
      describe('when the component receives a custom header column template', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2304) FIXME: Cannot find name 'jest'.
          onColumnRename = jest.fn()
          // @ts-expect-error TS(2345) FIXME: Argument of type '{ renderColumnHeader: ({ title }... Remove this comment to see the full error message
    ...
    describe('about the card removing', () => {
      ...
      describe('when the component receives a custom card template', () => {
        ...
        beforeEach(() => {
          ...
          // @ts-expect-error TS(2304) FIXME: Cannot find name 'jest'.
          onCardRemove = jest.fn()
          // @ts-expect-error TS(2345) FIXME: Argument of type '{ renderCard: any; onCardRemove:... Remove this comment to see the full error message
  ...
  describe('when the board is uncontrolled', () => {
    ...
    describe('about the column adding', () => {
      ...
      describe('about the default column adder', () => {
        ...
        // @ts-expect-error TS(2582) FIXME: Cannot find name 'describe'. Do you need to instal... Remove this comment to see the full error message
        describe('when it receives the "allowAddColumn" and "onNewColumnConfirm" prop', () => {
          // @ts-expect-error TS(7034) FIXME: Variable 'onColumnNew' implicitly has type 'any' i... Remove this comment to see the full error message
          let onColumnNew, onNewColumnConfirm
    ...
    describe('about the card adding', () => {
      ...
      describe('when the component receives a custom header column template', () => {
        ...
        it('does not call the "onCardNew" callback', () => {
          // @ts-expect-error TS(2345) FIXME: Argument of type '{ renderColumnHeader: any; onCar... Remove this comment to see the full error message
      ...
      describe('when the component does not receive a custom header column template', () => {
        ...
        describe('when the component does not receive "allowAddCard" prop', () => {
          // @ts-expect-error TS(2304) FIXME: Cannot find name 'beforeEach'.
          beforeEach(() => {
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ allowAddCard: boolean; onNewCa... Remove this comment to see the full error message
        ...
        describe('when the component does not receive the "onNewCardConfirm" prop', () => {
          // @ts-expect-error TS(2304) FIXME: Cannot find name 'beforeEach'.
          beforeEach(() => {
            // @ts-expect-error TS(2345) FIXME: Argument of type '{ allowAddCard: boolean; onCardN... Remove this comment to see the full error message
        ...
        describe('when the component receives both the "allowAddCard" and "onNewCardConfirm" props', () => {
          ...
          describe('about the card position when it is added', () => {
            ...
            describe('when the position is specified to add the card on the top of the column', () => {
              // @ts-expect-error TS(2304) FIXME: Cannot find name 'beforeEach'.
              beforeEach(async () => {
                // @ts-expect-error TS(2345) FIXME: Argument of type '{ allowAddCard: { on: string; };... Remove this comment to see the full error message
